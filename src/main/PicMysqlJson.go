...
func main() {
	...
	// file, e := ioutil.ReadFile("/Users/xiwi/Documents/design/pic/data/animals.json")
	// file, e := ioutil.ReadFile("/Users/xiwi/Documents/design/pic/data/arch.json")
	// file, e := ioutil.ReadFile("/Users/xiwi/Documents/design/pic/data/backgrounds.json")
	// file, e := ioutil.ReadFile("/Users/xiwi/Documents/design/pic/data/car.json")
	// file, e := ioutil.ReadFile("/Users/xiwi/Documents/design/pic/data/industry.json")
	// file, e := ioutil.ReadFile("/Users/xiwi/Documents/design/pic/data/places.json")
	// file, e := ioutil.ReadFile("/Users/xiwi/Documents/design/pic/data/plant.json")
	file, e := ioutil.ReadFile("/Users/xiwi/Documents/design/pic/data/people.json")
	////
